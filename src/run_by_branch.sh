...
$srcDir/clip_rasters_to_branches.py -d $current_branch_id \
    ...
    -r $tempHucDataDir/dem_meters.tif $tempHucDataDir/flowdir_d8_burned_filled.tif $tempHucDataDir/flowaccum_d8_burned_filled.tif \
    -c $tempCurrentBranchDataDir/dem_meters.tif $tempCurrentBranchDataDir/flowdir_d8_burned_filled.tif $tempCurrentBranchDataDir/flowaccum_d8_burned_filled.tif \
    -v
Tcount
