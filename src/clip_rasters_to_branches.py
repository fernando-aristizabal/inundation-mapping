...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-r', '--rasters', help='Raster file name to clip', required=True, default=None, nargs="+"
    )
    parser.add_argument(
        '-c',
        '--clipped-rasters',
        help='Branch polygons out file name',
        required=False,
        default=None,
        nargs="+",
    )
    ...
    stream_polygons_file, branch_id, branch_id_attribute, rasters, clipped_rasters, verbose = (
        args["branches"],
        args["branch_id"],
        args["branch_id_attribute"],
        args["rasters"],
        args["clipped_rasters"],
        args["verbose"],
    )
    ...
    for raster, clipped_raster in tqdm(
